...
<body>
    ...
    <main>
        ...
        <section id="introSection">
            <div>
                <h1>Santani Life Care<br>Foundation</h1>
        ...
        <?php include_once "user/view/TeamLeaders.html" ?>
